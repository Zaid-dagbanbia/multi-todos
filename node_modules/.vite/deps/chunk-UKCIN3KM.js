...
var _excluded19 = ["badgeContent", "children", "invisible", "max", "slotProps", "slots", "showZero"];
...
var _excluded20 = ["action", "children", "disabled", "focusableWhenDisabled", "onFocusVisible", "slotProps", "slots"];
...
var _excluded21 = ["defaultValue", "children", "disabled", "error", "onChange", "required", "slotProps", "slots", "value"];
...
var _excluded23 = ["aria-describedby", "aria-label", "aria-labelledby", "autoComplete", "autoFocus", "className", "defaultValue", "disabled", "endAdornment", "error", "id", "multiline", "name", "onClick", "onChange", "onKeyDown", "onKeyUp", "onFocus", "onBlur", "placeholder", "readOnly", "required", "startAdornment", "value", "type", "rows", "slotProps", "slots", "minRows", "maxRows"];
...
var _excluded26 = ["actions", "anchorEl", "children", "defaultOpen", "listboxId", "onOpenChange", "open", "slotProps", "slots"];
...
var Menu = React57.forwardRef(function Menu2(props, forwardedRef) {
...
var MenuItem = React60.forwardRef(function MenuItem2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var OptionGroup = React61.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
var Option = React63.forwardRef(function Option2(props, forwardedRef) {
...
var Option_default = React63.memo(Option);
...
function useSelect(props) {
  ...
  const ignoreEnterKeyUp = React64.useRef(false);
  const ignoreClick = React64.useRef(false);
  const [listboxFocusRequested, requestListboxFocus] = React64.useState(false);
  const focusListboxIfRequested = React64.useCallback(() => {
  ...
  const handleStateChange = React64.useCallback((e, field, fieldValue) => {
    if (field === "open") {
      onOpenChange == null ? void 0 : onOpenChange(fieldValue);
...
var _excluded30 = ["autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "onChange", "onListboxOpenChange", "optionStringifier", "renderValue", "slotProps", "slots", "value"];
...
var _excluded40 = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"];
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UKCIN3KM.js.map
